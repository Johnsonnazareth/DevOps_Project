  ...
  stages {
   ...
   stage('Nexus upload'){
        steps {
           ...
           nexusArtifactUploader artifacts: [[artifactId: 'mavenapp', classifier: '', file: 'target/maveapp-1.0.0.9.war', type: 'war']], credentialsId: 'nexus3', groupId: 'com.myapp', nexusUrl: '15.206.211.85:8081', nexusVersion: 'nexus3', protocol: 'http', repository: 'Jenkins', version: '1.0.0.9'
     }  
   }
    stage ('Deploy') {
      steps {
